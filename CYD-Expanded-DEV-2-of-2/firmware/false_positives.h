...
/*
 * ========================= USER-EDITABLE TABLE =========================
 * Add ONLY explicit known non-glasses advertised-name patterns here.
 * Do not blacklist an entire Company ID. Matching is case-insensitive
 * substring matching. Keep the final nullptr sentinel LAST.
 *
 * Row format:
 * { "name pattern", "assumed device", "device type", "reason" },
 * =======================================================================
 */
/*
 * glasses-finder-cyd-dev v6.1
 * Editable false-positive / assumed-device rules.
 *
 * IMPORTANT:
 * Sony Company ID 0x012D is NOT globally blocked.
 * Only specifically named known audio products are suppressed.
 */
