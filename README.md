...
5. Tweezers
6. Multimeter
7. Heat-shrink or electrical tape if required
8. Helping hands / PCB holder if required
...
After WiFi capabilities are added this process might change to auto update the database on know networks.
---
