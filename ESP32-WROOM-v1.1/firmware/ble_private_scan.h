...
/*
 * ESP32 WROOM Glasses Scanner Lite v1.1 — Bluedroid PRIVATE NRPA adapter
...
#error "ESP32 WROOM Glasses Scanner Lite v1.1 requires the Arduino-ESP32 Bluedroid BLE backend. Select a classic ESP32 / ESP32 Dev Module board using ESP32 by Espressif Systems 3.3.11."
#endif
