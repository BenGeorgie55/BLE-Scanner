...
/*
 * ==========================================================================
 * ESP32 S3 Light — NimBLE PRIVATE NRPA adapter
 * ==========================================================================
 * Target:
...
#error "ESP32 S3 Light requires the Arduino-ESP32 NimBLE backend. Select an ESP32-S3 board using ESP32 by Espressif Systems 3.3.11."
#endif
