/*
 * glasses-finder-cyd-dev v6.3 TEST CANDIDATE — Smart Glasses Detector + Private-Rotating BLE Scanner
 * v6.3 TEST CANDIDATE — v6.2 PRIVATE-NRPA REPAIR + ANKO CAMERA-GLASSES RULE — REVALIDATE AFTER FLASH.
 ...
 *   ESP-GlassHole: https://github.com/surveillancewatch/ESP-GlassHole/tree/main/firmware
 *   glass-detect:  https://github.com/sh4d0wm45k/glass-detect/
 *
...
// glasses-finder-cyd-dev v6.3 test-candidate display validation: this build MUST use ILI9341.
...
// ============================================================
// v6.3 test candidate — Local BLE Scanner Address Privacy
// ============================================================
...
void showScanningNow() {
    ...
    tft.setTextSize(2);
    tft.setCursor(8, 20);
    tft.print("ESP GLASSES SCANNER v6.3T");
...
void setup() {
    ...
    // v6.3 test candidate RF privacy: create and confirm a fresh PRIVATE NRPA before the
...
void loop() {
    ...
    // v6.3 test candidate: rotate/recover the CYD's own PRIVATE NRPA only while BLE is idle.
