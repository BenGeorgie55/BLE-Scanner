...
/*
 * ============================================================================
 * CYD Dev Lite — PRIVATE BLE SCANNER ADDRESS ADAPTER
 * ============================================================================
 *
 * Target stack:
 ...
 *
 * CYD Dev Lite uses a Non-Resolvable Private Address (NRPA) as the CYD scanner's own
...
#error "CYD Dev Lite PRIVATE NRPA scanner-address support requires the Arduino-ESP32 Bluedroid BLE backend"
#endif
