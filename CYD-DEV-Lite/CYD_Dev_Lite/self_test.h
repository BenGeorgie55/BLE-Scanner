...
/*
  =============================================================================
  USER-EDITABLE CYD DEV LITE SELF TEST
  =============================================================================
...
void startSelfTest() {
    ...
    drawSelfTestMessage("SELF TEST", "Mirrors CYD Dev Lite operational functions");
}
...
void enterSelfTestStep(uint8_t step) {
    ...
    switch (selfTestStep) {
        ...
        case 11:
            clearSelfTestWarnings();
            rgbGreen();
            drawSelfTestMessage("SELF TEST PASSED", "CYD Dev Lite UI + LED test complete");
            break;
