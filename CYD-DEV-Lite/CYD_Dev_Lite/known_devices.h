...
static const KnownDeviceRule KNOWN_DEVICES[] = {
    ...
    // ---------------------------------------------------------------------
    // Session 19 — identified ordinary BLE devices from CYD/S3 side-by-side
    // field testing. Annotation only; these rows do NOT create glasses alerts.
    // ---------------------------------------------------------------------

    // Fitness / sensors / vehicle diagnostics.
    { "Inspire 2", 0xFFFF, KNOWN_EXACT, "Fitbit", "Fitbit Inspire 2", "Fitness Tracker" },
    { "TICKR",     0xFFFF, KNOWN_EXACT, "Wahoo",  "Wahoo TICKR",      "Heart Rate Monitor" },
    { "FIXD",      0xFFFF, KNOWN_EXACT, "FIXD",   "FIXD Diagnostic Sensor", "Vehicle OBD-II Diagnostic Sensor" },

    // Teltonika FMC125 advertisements include a device-specific suffix.
    { "FMC125:", 0xFFFF, KNOWN_PREFIX, "Teltonika", "Teltonika FMC125", "Vehicle / GNSS Tracking Unit" },

    // JBL audio observed in Session 19.
    { "JBL Charge 5",    0xFFFF, KNOWN_EXACT,  "JBL", "JBL Charge 5", "Speaker" },
    { "JBL TUNE BEAM-LE",0xFFFF, KNOWN_EXACT,  "JBL", "JBL Tune Beam", "Earbuds" },
    { "JBL Xtreme",      0xFFFF, KNOWN_PREFIX, "JBL", "JBL Xtreme family", "Speaker" },

    // Other identified audio devices.
    { "OpenFit Air by Shokz", 0xFFFF, KNOWN_EXACT, "Shokz",      "Shokz OpenFit Air", "Open-Ear Headphones" },
    { "Sonos Ace",             0xFFFF, KNOWN_EXACT, "Sonos",      "Sonos Ace", "Headphones" },
    { "ACCENTUM",              0xFFFF, KNOWN_EXACT, "Sennheiser", "Sennheiser ACCENTUM", "Headphones" },
    { "LE-Bose QC45",          0xFFFF, KNOWN_EXACT, "Bose",       "Bose QuietComfort 45", "Headphones" },
    { "LE-Bose QC Headphones", 0xFFFF, KNOWN_EXACT, "Bose",       "Bose QuietComfort Headphones", "Headphones" },

    // Printer / cycling.
    { "ET-2850 Series", 0xFFFF, KNOWN_EXACT, "Epson",  "Epson ET-2850", "Printer" },
    { "Rider460",       0xFFFF, KNOWN_EXACT, "Bryton", "Bryton Rider 460", "GPS Bike Computer" },

    // BlackVue dashcams. Device-specific suffixes follow these family prefixes.
    // Intentionally scoped to known families rather than a generic "BlackVue" rule.
    { "BlackVue770X-",    0xFFFF, KNOWN_PREFIX, "BlackVue", "BlackVue DR770X", "Dashcam" },
    { "BlackVue970X-",    0xFFFF, KNOWN_PREFIX, "BlackVue", "BlackVue DR970X", "Dashcam" },
    { "BlackVue970XLTE-", 0xFFFF, KNOWN_PREFIX, "BlackVue", "BlackVue DR970X LTE", "Dashcam" },
    { "BlackVue900X",     0xFFFF, KNOWN_PREFIX, "BlackVue", "BlackVue DR900X", "Dashcam" },
