...
/*
 * ============================================================================
 * CYD v6.3 TEST CANDIDATE — PRIVATE BLE SCANNER ADDRESS ADAPTER
 * ============================================================================
 *
 * Target stack:
 ...
 *
 * v6.3 test candidate uses a Non-Resolvable Private Address (NRPA) as the CYD scanner's own
...
#error "v6.3 PRIVATE NRPA scanner-address support requires the Arduino-ESP32 Bluedroid BLE backend"
#endif
