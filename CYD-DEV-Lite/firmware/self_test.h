...
/*
  =============================================================================
  USER-EDITABLE V6.3 TEST-CANDIDATE SELF TEST
  =============================================================================
...
void startSelfTest() {
    ...
    drawSelfTestMessage("SELF TEST", "Mirrors v6.3 candidate operational functions");
}
...
void enterSelfTestStep(uint8_t step) {
    ...
    switch (selfTestStep) {
        ...
        case 11:
            clearSelfTestWarnings();
            rgbGreen();
            drawSelfTestMessage("SELF TEST PASSED", "V6.3 candidate UI + LED test complete");
            break;
