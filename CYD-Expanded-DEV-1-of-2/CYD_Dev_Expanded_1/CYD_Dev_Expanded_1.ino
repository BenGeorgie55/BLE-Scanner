...
// CYD Dev Expanded 1 display validation: this build MUST use ILI9341.
...
// ============================================================
// CYD Dev Expanded 1 — Local BLE Scanner Address Privacy (inherited from validated v6.3 RF baseline)
// ============================================================
...
void updateSentryMode() {
    ...
    // CYD Dev Expanded 1: Sentry legal/dashboard wake gates use the physical BOOT button.
    ...
    if (pressed != lastPageButtonPressed &&
        ...
        if (pressed) {
            ...
            if (currentPage == PAGE_STATUS) {
                // CYD Dev Expanded 1 Sentry BOOT gates take precedence while the display is dark
...
void printSerialSystemStats(uint32_t nowMs) {
    ...
    Serial.println();
    Serial.println("============================================================");
    Serial.println("CYD DEV EXPANDED 1 - SYS STAT");
    Serial.println("============================================================");
...
void setup() {
    ...
    // CYD Dev Expanded 1 retains the validated v6.3 RF privacy path: create and confirm a fresh PRIVATE NRPA before the
...
void loop() {
    ...
    // CYD Dev Expanded 1 retains the validated v6.3 behavior: rotate/recover the CYD's own PRIVATE NRPA only while BLE is idle.
