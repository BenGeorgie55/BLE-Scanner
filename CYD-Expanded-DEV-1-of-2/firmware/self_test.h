...
/*
  =============================================================================
  USER-EDITABLE CYD V8 UNTESTED SELF TEST
  =============================================================================
...
void startSelfTest() {
    ...
    drawSelfTestMessage("SELF TEST", "Mirrors CYD v8 operational functions");
}
...
void enterSelfTestStep(uint8_t step) {
    ...
    switch (selfTestStep) {
        ...
        case 11:
            clearSelfTestWarnings();
            rgbGreen();
            drawSelfTestMessage("SELF TEST PASSED", "CYD v8 UI + LED test complete");
            break;
